...
module.exports = class ElephantFactCommand extends BaseCommand {
	constructor() {
		super(
			"elephantfact",
			"facts",
			[],
			"(help)",
			"Sends a fact about elpehants",
			"",
			["SEND_MESSAGES", "EMBED_LINKS"],
			["elephantfact help` - Sends the help command"],
			["elephantfact", "elephantfact help"],
			true,
			3000,
			false,
			false,
