...
module.exports = class GiraffeFactCommand extends BaseCommand {
	constructor() {
		super(
			"giraffefact",
			"facts",
			[],
			"(help)",
			"Sends a fact about giraffes",
			"",
			["SEND_MESSAGES", "EMBED_LINKS"],
			["giraffefact help` - Sends the help command"],
			["giraffefact", "giraffefact help"],
			true,
			3000,
			false,
			false,
