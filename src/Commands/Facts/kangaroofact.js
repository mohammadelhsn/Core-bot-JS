...
module.exports = class KangarooFactCommand extends BaseCommand {
	constructor() {
		super(
			"kangaroofact",
			"facts",
			[],
			"(help)",
			"Sends a fact about kangaroos",
			"",
			["SEND_MESSAGES", "EMBED_LINKS"],
			["kangaroofact help` - Sends the help command"],
			["kangaroofact", "kangaroofact help"],
			true,
			3000,
			false,
			false,
