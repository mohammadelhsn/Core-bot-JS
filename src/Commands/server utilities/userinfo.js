...
module.exports = class UserInfoCommand extends BaseCommand {
	constructor() {
		super(
			...
			["whois", "ui"],
			"(mention)",
			"Gives information on the mentioned user or the author of the message.",
			"",
			["SEND_MESSAGES", "EMBED_LINKS"],
			["userinfo help` - Shows the help message for this command."],
			["userinfo", "userinfo @Tech!", "userinfo help"],
			true,
			5000,
			false,
			false,
