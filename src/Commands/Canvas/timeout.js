...
module.exports = class TimeoutCommand extends BaseCommand {
	constructor() {
		super(
			"timeout",
			"canvas",
		...
		if (args[0]) {
			if (args[0].toLowerCase() == "help") {
				...
				try {
					...
					const link = `https://api.no-api-key.com/api/v2/timeout?image=${avatar}`;
					const attachment = new MessageAttachment(link, "timeout.png");
