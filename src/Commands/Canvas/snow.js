...
module.exports = class SnowCommand extends BaseCommand {
	constructor() {
		super(
			"snow",
			"canvas",
		...
		if (args[0]) {
			if (args[0].toLowerCase() == "help") {
				...
				try {
					...
					const link = `https://api.no-api-key.com/api/v2/snow?image=${avatar}`;
					const attachment = new MessageAttachment(link, "snow.png");
