...
module.exports = class SmartCommand extends BaseCommand {
	constructor() {
		super(
			"smart",
			"canvas",
		...
		if (args[0]) {
			if (args[0].toLowerCase() == "help") {
				...
				try {
					...
					const link = `https://api.no-api-key.com/api/v2/smrt?image=${avatar}`;
					const attachment = new MessageAttachment(link, "smrt.png");
